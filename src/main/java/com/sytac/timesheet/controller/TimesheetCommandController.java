...
public class TimesheetCommandController {
    ...
    // TODO save draft endpoint
    /*@PutMapping(produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<Timesheet> submitTimesheet(@PathVariable final int year, @PathVariable final Month month,
    ...
    public ResponseEntity<Timesheet> submitTimesheet(@PathVariable final int year, @PathVariable final Month month,
                                                   @RequestBody final Timesheet timesheet) {
        return ResponseEntity.ok(timesheetCommandService.submitTimesheet(YearMonth.of(year, month), timesheet));
    }
